...
export const sendInviteSuccess = (invites) => ({
  type: types.SEND_INVITE_SUCCESS,
  invites,
});

export const fetchInvites = (invitable) => ({
...
export const removeRoleSuccess = (roles) => ({
